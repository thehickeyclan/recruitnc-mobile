...
export function TocMadness({ onStart }: { onStart: () => void }) {
  ...
  return (
    <View style={styles.card}>
      ...
      <Text style={styles.fine}>One entry per account. Prizes announced soon.</Text>
    </View>
  )
}
...
const styles = StyleSheet.create({
  ...
  fine: { ...type.caption, color: colors.textMuted, textAlign: "center", fontWeight: "600", letterSpacing: 0.2 },
})
